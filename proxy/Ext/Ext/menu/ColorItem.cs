...
namespace Ext.menu {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\contrib\ExtJsParser\ext-2.2\source\widgets\menu\ColorItem.js</jssource>
	public class ColorItem : Ext.menu.Adapter {

		/// <summary>Creates a new ColorItem</summary>
		/// <returns></returns>
		public extern ColorItem();
		/// <summary>Creates a new ColorItem</summary>
		/// <param name="config">Configuration options</param>
		/// <returns></returns>
		public extern ColorItem(object config);
		/// <summary>Creates a new Adapter</summary>
		/// <param name="component">The component being adapted to render into a menu</param>
		/// <returns></returns>
		public extern ColorItem(Ext.Component component);
		/// <summary>Creates a new Adapter</summary>
		/// <param name="component">The component being adapted to render into a menu</param>
		/// <param name="config">Configuration options</param>
		/// <returns></returns>
		public extern ColorItem(Ext.Component component, object config);
		/// <summary>
		...
		/// <returns></returns>
		public extern ColorItem(Ext.Element config);
		/// <summary>
		///     element and its id used as the component id.  If a string is passed, it is assumed to be the id of an existing element
		///     and is used as the component id.  Otherwise, it is assumed to be a standard config object and is applied to the component.
		/// </summary>
		/// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
		/// <returns></returns>
		public extern ColorItem(string config);

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public extern static ColorItem prototype { get; set; }
		...
		/// <summary>The Ext.ColorPalette object</summary>
		public extern Ext.ColorPalette palette { get; set; }
	...
	[JsAnonymous]
	public class ColorItemConfig : System.DotWeb.JsDynamic {
