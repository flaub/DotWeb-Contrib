...
namespace Ext.menu {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\contrib\proxy\ExtJsParser\ext-2.2\source\widgets\menu\DateItem.js</jssource>
	public class DateItem : Ext.menu.Adapter {

		/// <summary>Creates a new DateItem</summary>
		/// <returns></returns>
		public extern DateItem();
		/// <summary>Creates a new DateItem</summary>
		/// <param name="config">Configuration options</param>
		/// <returns></returns>
		public extern DateItem(object config);
		/// <summary>Creates a new Adapter</summary>
		/// <param name="component">The component being adapted to render into a menu</param>
		/// <returns></returns>
		public extern DateItem(Ext.Component component);
		/// <summary>Creates a new Adapter</summary>
		/// <param name="component">The component being adapted to render into a menu</param>
		/// <param name="config">Configuration options</param>
		/// <returns></returns>
		public extern DateItem(Ext.Component component, object config);
		/// <summary>
		...
		/// <returns></returns>
		public extern DateItem(Ext.Element config);
		/// <summary>
		///     element and its id used as the component id.  If a string is passed, it is assumed to be the id of an existing element
		///     and is used as the component id.  Otherwise, it is assumed to be a standard config object and is applied to the component.
		/// </summary>
		/// <param name="config">The configuration options.  If an element is passed, it is set as the internal</param>
		/// <returns></returns>
		public extern DateItem(string config);

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public extern static DateItem prototype { get; set; }

		/// <summary>The reference to the constructor function</summary>
		public extern static Delegate constructor { get; set; }

		/// <summary>The reference to the class that this class inherits from</summary>
		public extern static Ext.menu.Adapter superclass { get; set; }

		/// <summary>The Ext.DatePicker object</summary>
		public extern Ext.DatePicker picker { get; set; }
	...
	[JsAnonymous]
	public class DateItemConfig : System.DotWeb.JsDynamic {
