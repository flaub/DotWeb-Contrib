...
namespace Ext.menu {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\contrib\ExtJsParser\ext-2.2\source\widgets\menu\TextItem.js</jssource>
	public class TextItem : Ext.menu.BaseItem {
		...
		/// <returns></returns>
		public extern TextItem(object config);
		/// <summary>
		///     Creates a new TextItem
		///     is applied as a config object (and should contain a <tt>text</tt> property).
		/// </summary>
		/// <param name="config">If config is a string, it is used as the text to display, otherwise it</param>
		/// <returns></returns>
		public extern TextItem(string config);
		/// <summary>
		...
		/// <returns></returns>
		public extern TextItem(Ext.Element config);
	...
	[JsAnonymous]
	public class TextItemConfig : System.DotWeb.JsDynamic {
		/// <summary> The text to display for this item (defaults to '')</summary>
