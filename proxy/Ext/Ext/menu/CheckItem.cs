...
namespace Ext.menu {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\contrib\ExtJsParser\ext-2.2\source\widgets\menu\CheckItem.js</jssource>
	...
	public class CheckItemConfig : System.DotWeb.JsDynamic {
		...
		public string group { get { return (string)this["group"]; } set { this["group"] = value; } }

		/// <summary> The default CSS class to use for check items (defaults to "x-menu-item x-menu-check-item")</summary>
		public string itemCls { get { return (string)this["itemCls"]; } set { this["itemCls"] = value; } }

		/// <summary> The default CSS class to use for radio group check items (defaults to "x-menu-group-item")</summary>
		public string groupClass { get { return (string)this["groupClass"]; } set { this["groupClass"] = value; } }
