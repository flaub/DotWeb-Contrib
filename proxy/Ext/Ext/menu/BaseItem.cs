...
namespace Ext.menu {
	...
	/// </summary>
	/// <jssource>D:\src\git\DotWeb\contrib\proxy\ExtJsParser\ext-2.3\widgets\menu\BaseItem.js</jssource>
	public class BaseItem : Ext.Component {
		...
		/// <summary>Cascade destroy to subMenus if they exist</summary>
		/// <returns></returns>
