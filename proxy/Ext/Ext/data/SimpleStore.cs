...
namespace Ext.data {
	...
	/// </summary>
	/// <jssource>D:\src\git\DotWeb\contrib\proxy\ExtJsParser\ext-2.3\data\SimpleStore.js</jssource>
	...
	public class SimpleStoreConfig : System.DotWeb.JsDynamic {
		...
		/// <summary> An array of field definition objects, or field name string as specified to {@link Ext.data.Record#create}</summary>
