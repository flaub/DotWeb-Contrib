...
namespace Ext.grid {
	...
	/// </summary>
	/// <jssource>D:\src\git\DotWeb\contrib\proxy\ExtJsParser\ext-2.3\widgets\grid\EditorGrid.js</jssource>
	public class EditorGridPanel : Ext.grid.GridPanel {

		/// <summary></summary>
		/// <returns></returns>
		public extern EditorGridPanel();
		/// <summary></summary>
		/// <param name="config">The config object</param>
		/// <returns></returns>
		public extern EditorGridPanel(object config);
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public extern EditorGridPanel(Ext.Element config);
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public extern EditorGridPanel(string config);

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public extern static EditorGridPanel prototype { get; set; }

		/// <summary>The reference to the constructor function</summary>
		public extern static Delegate constructor { get; set; }

		/// <summary>The reference to the class that this class inherits from</summary>
		public extern static Ext.grid.GridPanel superclass { get; set; }
		...
		/// <summary>
		///     Any subclass of AbstractSelectionModel that will provide the selection model forthe grid (defaults to {@link Ext.grid.CellSelectionModel} if not specified). Note that the SelectionModel
		...
		/// <summary>The currently active editor or null</summary>
		public extern Ext.Editor activeEditor { get; set; }


		/// <summary>Starts editing the specified for the specified row/column</summary>
		/// <returns></returns>
		public extern virtual void startEditing();

		/// <summary>Starts editing the specified for the specified row/column</summary>
		/// <param name="rowIndex"></param>
		/// <returns></returns>
		public extern virtual void startEditing(double rowIndex);

		/// <summary>Starts editing the specified for the specified row/column</summary>
		/// <param name="rowIndex"></param>
		/// <param name="colIndex"></param>
		/// <returns></returns>
		public extern virtual void startEditing(double rowIndex, double colIndex);

		/// <summary>Stops any active editing</summary>
		/// <returns></returns>
		public extern virtual void stopEditing();

		/// <summary>Stops any active editing</summary>
		/// <param name="cancel">(optional) True to cancel any changes</param>
		/// <returns></returns>
		public extern virtual void stopEditing(bool cancel);
	...
	[JsAnonymous]
	public class EditorGridPanelConfig : System.DotWeb.JsDynamic {
