...
namespace Ext {
	...
	public class CycleButtonConfig : System.DotWeb.JsDynamic {
		...
		public System.Array items { get { return (System.Array)this["items"]; } set { this["items"] = value; } }

		/// <summary> True to display the active item's text as the button text (defaults to false)</summary>
		public bool showText { get { return (bool)this["showText"]; } set { this["showText"] = value; } }
		...
		public string prependText { get { return (string)this["prependText"]; } set { this["prependText"] = value; } }
		...
		public Delegate changeHandler { get { return (Delegate)this["changeHandler"]; } set { this["changeHandler"] = value; } }
		...
		public string forceIcon { get { return (string)this["forceIcon"]; } set { this["forceIcon"] = value; } }

		/// <summary> A function called when the arrow button is clicked (can be used instead of click event)</summary>
		public Delegate arrowHandler { get { return (Delegate)this["arrowHandler"]; } set { this["arrowHandler"] = value; } }

		/// <summary> The title attribute of the arrow</summary>
		public string arrowTooltip { get { return (string)this["arrowTooltip"]; } set { this["arrowTooltip"] = value; } }
