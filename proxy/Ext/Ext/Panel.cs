...
namespace Ext {
	...
	/// </summary>
	/// <jssource>D:\src\git\DotWeb\contrib\proxy\ExtJsParser\ext-2.2\source\widgets\Panel.js</jssource>
	public class Panel : Ext.Container {
		...
		/// <summary>Sets the title text for the panel and optionally the icon class.</summary>
		/// <returns></returns>
