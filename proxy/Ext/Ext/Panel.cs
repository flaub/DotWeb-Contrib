...
namespace Ext {
	...
	/// </summary>
	/// <jssource>D:\src\git\DotWeb\contrib\proxy\ExtJsParser\ext-2.3\widgets\Panel.js</jssource>
	public class Panel : Ext.Container {
		...
		/// <returns></returns>
		public extern Panel(object config);
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public extern Panel(Ext.Element config);
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public extern Panel(string config);

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public extern static Panel prototype { get; set; }
		...
		/// </summary>
		public extern Ext.Element header { get; set; }
		...
		/// </summary>
		public extern Ext.Element body { get; set; }
		...
		/// </summary>
		public extern Ext.Element footer { get; set; }
		...
		/// </summary>
		public extern Ext.dd.DragSource dd { get; set; }
		...
		/// <summary>Returns the toolbar from the top (tbar) section of the panel.</summary>
		/// <returns>Ext.Toolbar</returns>
		public extern virtual void getTopToolbar();

		/// <summary>Returns the toolbar from the bottom (bbar) section of the panel.</summary>
		/// <returns>Ext.Toolbar</returns>
		public extern virtual void getBottomToolbar();
		...
		///     button config, an object will be treated as a button config object.
		/// </summary>
		/// <param name="config">A valid {@link Ext.Button} config.  A string will become the text for a default</param>
		/// <returns>Ext.Button</returns>
		public extern virtual void addButton(string config);
		...
		/// <returns>Ext.Button</returns>
		public extern virtual void addButton(string config, Delegate handler);
		...
		/// <param name="config">A valid {@link Ext.Button} config.  A string will become the text for a default</param>
		/// <param name="handler">The function to be called on button {@link Ext.Button#click}</param>
		/// <param name="scope">The scope to use for the button handler function</param>
		/// <returns>Ext.Button</returns>
		public extern virtual void addButton(string config, Delegate handler, object scope);
		...
		/// <param name="handler">The function to be called on button {@link Ext.Button#click}</param>
		/// <returns>Ext.Button</returns>
		public extern virtual void addButton(object config, Delegate handler);
		...
		/// <param name="scope">The scope to use for the button handler function</param>
		/// <returns>Ext.Button</returns>
		public extern virtual void addButton(object config, Delegate handler, object scope);
		...
		///     {@link #animCollapse} panel config)
		/// </summary>
		/// <param name="animate">True to animate the transition, else false (defaults to the value of the</param>
		/// <returns>Ext.Panel</returns>
		public extern virtual void collapse(bool animate);
		...
		/// <param name="animate">True to animate the transition, else false (defaults to the value of the</param>
		/// <returns>Ext.Panel</returns>
		public extern virtual void expand(bool animate);
		...
		/// </summary>
		/// <returns>Ext.Panel</returns>
		public extern virtual void toggleCollapse();
		...
		/// <param name="animate">True to animate the transition, else false (defaults to the value of the</param>
		/// <returns>Ext.Panel</returns>
		public extern virtual void toggleCollapse(bool animate);
		...
		/// </summary>
		/// <returns>Number</returns>
		public extern virtual void getFrameHeight();
		...
		/// </summary>
		/// <returns>Number</returns>
		public extern virtual void getInnerWidth();
		...
		/// </summary>
		/// <returns>Number</returns>
		public extern virtual void getInnerHeight();
		...
		/// </summary>
		/// <returns></returns>
		public extern virtual void setTitle();
		...
		/// <returns></returns>
		public extern virtual void setTitle(string title);
		...
		/// </summary>
		/// <param name="title">The title text to set</param>
		/// <param name="iconCls">(optional) iconCls A user-defined CSS class that provides the icon image for this panel</param>
		/// <returns></returns>
		public extern virtual void setTitle(string title, string iconCls);
		...
		///     associated property on this panel Updater instance.
		/// </summary>
		/// <param name="config">A config object containing any of the following options:</param>
		/// <returns>Ext.Panel</returns>
		public extern virtual void load(object config);
		...
		/// <param name="config">A config object containing any of the following options:</param>
		/// <returns>Ext.Panel</returns>
		public extern virtual void load(string config);
		...
		/// <param name="config">A config object containing any of the following options:</param>
		/// <returns>Ext.Panel</returns>
		public extern virtual void load(Delegate config);

		/// <summary>Retrieve a tool by id.</summary>
		/// <returns>Object</returns>
		public extern virtual void getTool();

		/// <summary>Retrieve a tool by id.</summary>
		/// <param name="id"></param>
		/// <returns>Object</returns>
		public extern virtual void getTool(string id);
	...
	[JsAnonymous]
	public class PanelConfig : System.DotWeb.JsDynamic {
    ...
    public class PanelEvents {
        /// <summary>Fires after the Panel has been resized.
        /// <pre><code>
        /// USAGE: ({Ext.Panel} p, {Number} width, {Number} height)
        /// </code></pre>
        /// <list type="bullet">
        /// <item><term><b>p</b></term><description>the Panel which has been resized.</description></item>
        /// <item><term><b>width</b></term><description>The Panel's new width.</description></item>
        /// <item><term><b>height</b></term><description>The Panel's new height.</description></item>
        /// </list>
        /// </summary>
        public static string bodyresize { get { return "bodyresize"; } }
        /// <summary>Fires after the Panel title has been set or changed.
        /// <pre><code>
        /// USAGE: ({Ext.Panel} p, {String} The)
        /// </code></pre>
        /// <list type="bullet">
        /// <item><term><b>p</b></term><description>the Panel which has had its title changed.</description></item>
        /// <item><term><b>The</b></term><description>new title.</description></item>
        /// </list>
        /// </summary>
        public static string titlechange { get { return "titlechange"; } }
        /// <summary>Fires after the Panel icon class has been set or changed.
        /// <pre><code>
        /// USAGE: ({Ext.Panel} p, {String} The, {String} The2)
        /// </code></pre>
        /// <list type="bullet">
        /// <item><term><b>p</b></term><description>the Panel which has had its icon class changed.</description></item>
        /// <item><term><b>The</b></term><description>new icon class.</description></item>
        /// <item><term><b>The2</b></term><description>old icon class.</description></item>
        /// </list>
        /// </summary>
        public static string iconchange { get { return "iconchange"; } }
        /// <summary>Fires after the Panel has been collapsed.
        /// <pre><code>
        /// USAGE: ({Ext.Panel} p)
        /// </code></pre>
        /// <list type="bullet">
        /// <item><term><b>p</b></term><description>the Panel that has been collapsed.</description></item>
        /// </list>
        /// </summary>
        public static string collapse { get { return "collapse"; } }
        /// <summary>Fires after the Panel has been expanded.
        /// <pre><code>
        /// USAGE: ({Ext.Panel} p)
        /// </code></pre>
        /// <list type="bullet">
        /// <item><term><b>p</b></term><description>The Panel that has been expanded.</description></item>
        /// </list>
        /// </summary>
        public static string expand { get { return "expand"; } }
        /// <summary>Fires before the Panel is collapsed.  A handler can return false to cancel the collapse.
        /// <pre><code>
        /// USAGE: ({Ext.Panel} p, {Boolean} animate)
        /// </code></pre>
        /// <list type="bullet">
        /// <item><term><b>p</b></term><description>the Panel being collapsed.</description></item>
        /// <item><term><b>animate</b></term><description>True if the collapse is animated, else false.</description></item>
        /// </list>
        /// </summary>
        public static string beforecollapse { get { return "beforecollapse"; } }
        /// <summary>Fires before the Panel is expanded.  A handler can return false to cancel the expand.
        /// <pre><code>
        /// USAGE: ({Ext.Panel} p, {Boolean} animate)
        /// </code></pre>
        /// <list type="bullet">
        /// <item><term><b>p</b></term><description>The Panel being expanded.</description></item>
        /// <item><term><b>animate</b></term><description>True if the expand is animated, else false.</description></item>
        /// </list>
        /// </summary>
        ...
        /// </code></pre>
        /// <list type="bullet">
        /// <item><term><b>p</b></term><description>The Panel being closed.</description></item>
        /// </list>
        /// </summary>
        public static string beforeclose { get { return "beforeclose"; } }
        /// <summary>
        ...
        /// </code></pre>
        /// <list type="bullet">
        /// <item><term><b>p</b></term><description>The Panel that has been closed.</description></item>
        /// </list>
        /// </summary>
        ...
        /// </code></pre>
        /// <list type="bullet">
        /// <item><term><b>p</b></term><description>The Panel that has been activated.</description></item>
        /// </list>
        /// </summary>
        ...
        /// </code></pre>
        /// <list type="bullet">
        /// <item><term><b>p</b></term><description>The Panel that has been deactivated.</description></item>
        /// </list>
        /// </summary>
        public static string deactivate { get { return "deactivate"; } }
    }

    public delegate void PanelBodyresizeDelegate(Ext.Panel p, double width, double height);
    public delegate void PanelTitlechangeDelegate(Ext.Panel p, string The);
    public delegate void PanelIconchangeDelegate(Ext.Panel p, string The, string The2);
    public delegate void PanelCollapseDelegate(Ext.Panel p);
    public delegate void PanelExpandDelegate(Ext.Panel p);
    public delegate void PanelBeforecollapseDelegate(Ext.Panel p, bool animate);
    public delegate void PanelBeforeexpandDelegate(Ext.Panel p, bool animate);
    public delegate void PanelBeforecloseDelegate(Ext.Panel p);
    public delegate void PanelCloseDelegate(Ext.Panel p);
    public delegate void PanelActivateDelegate(Ext.Panel p);
    public delegate void PanelDeactivateDelegate(Ext.Panel p);
}
