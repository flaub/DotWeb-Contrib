...
namespace Ext.form {
	...
	/// </summary>
	/// <jssource>D:\src\git\DotWeb\contrib\proxy\ExtJsParser\ext-2.3\widgets\form\TriggerField.js</jssource>
	public class TriggerField : Ext.form.TextField {
		...
		/// <returns></returns>
		public extern TriggerField(object config);
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public extern TriggerField(Ext.Element config);
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public extern TriggerField(string config);

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public extern static TriggerField prototype { get; set; }
		...
		/// <summary>
		///     {@link Ext.DomHelper DomHelper} config object specifying the structure of thetrigger element for this Field. (Optional).</p>
		...
		/// <param name="e"></param>
		/// <returns></returns>
		public extern virtual void onTriggerClick(EventObject e);
	...
	[JsAnonymous]
	public class TriggerFieldConfig : System.DotWeb.JsDynamic {
