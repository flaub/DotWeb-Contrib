...
namespace Ext.form {
	...
	/// </summary>
	/// <jssource>D:\src\git\DotWeb\contrib\proxy\ExtJsParser\ext-2.2\source\widgets\form\Hidden.js</jssource>
	public class Hidden : Ext.form.Field {

		/// <summary>Create a new Hidden field.</summary>
		/// <returns></returns>
		public extern Hidden();
		/// <summary>Create a new Hidden field.</summary>
		/// <param name="config">Configuration options</param>
		/// <returns></returns>
		public extern Hidden(object config);
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public extern Hidden(Ext.Element config);
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public extern Hidden(string config);

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public extern static Hidden prototype { get; set; }
	...
	[JsAnonymous]
	public class HiddenConfig : System.DotWeb.JsDynamic {
