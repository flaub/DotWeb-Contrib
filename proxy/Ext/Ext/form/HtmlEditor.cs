...
namespace Ext.form {
	...
	///     </code></pre>
	/// </summary>
	/// <jssource>D:\src\git\DotWeb\contrib\proxy\ExtJsParser\ext-2.3\widgets\form\HtmlEditor.js</jssource>
	public class HtmlEditor : Ext.form.Field {
		...
		/// <summary>A default value to be put into the editor to resolve focus issues (defaults to &#8203;, &nbsp; in Opera).</summary>
