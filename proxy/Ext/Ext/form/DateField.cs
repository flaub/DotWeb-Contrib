...
namespace Ext.form {
	...
	/// </summary>
	/// <jssource>D:\src\git\DotWeb\contrib\proxy\ExtJsParser\ext-2.3\widgets\form\DateField.js</jssource>
    ...
    public class DateFieldEvents {
        /// <summary>Fires when a date is selected via the date picker.
        /// <pre><code>
        /// USAGE: ({Ext.form.DateField} objthis, {Date} date)
        /// </code></pre>
        /// <list type="bullet">
        /// <item><term><b>objthis</b></term><description></description></item>
        /// <item><term><b>date</b></term><description>The date that was selected</description></item>
        /// </list>
        /// </summary>
        public static string select { get { return "select"; } }
    }

    public delegate void DateFieldSelectDelegate(Ext.form.DateField objthis, System.DateTime date);
}
