...
namespace Ext.form {
	...
	public class ActionClass  {
		...
		/// <summary>
		///     parameter values to pass. These are added to the Form's{@link Ext.form.BasicForm#baseParams} and passed to the specified URL along with the Form's
		///     input fields.</p>
		///     <p>Parameters are encoded as standard HTTP parameters using {@link Ext#urlEncode}.</p>
		/// </summary>
		public extern object paramsExtra { get; set; }

		/// <summary>The number of milliseconds to wait for a server response beforefailing with the {@link #failureType} as {@link #Action.CONNECT_FAILURE}.</summary>
