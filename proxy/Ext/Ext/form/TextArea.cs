...
namespace Ext.form {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\contrib\ExtJsParser\ext-2.2\source\widgets\form\TextArea.js</jssource>
	public class TextArea : Ext.form.TextField {
		...
		/// <returns></returns>
		public extern TextArea(object config);
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public extern TextArea(Ext.Element config);
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public extern TextArea(string config);

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public extern static TextArea prototype { get; set; }
		...
		/// <summary>The minimum height to allow when grow = true (defaults to 60)</summary>
		public extern double growMin { get; set; }

		/// <summary>The maximum height to allow when grow = true (defaults to 1000)</summary>
		public extern double growMax { get; set; }

		/// <summary>True to prevent scrollbars from appearing regardless of how much text isin the field (equivalent to setting overflow: hidden, defaults to false)</summary>
		public extern bool preventScrollbars { get; set; }

		/// <summary>A DomHelper element spec, or true for a default element spec (defaults to{tag: "textarea", style: "width:100px;height:60px;", autocomplete: "off"})</summary>
	...
	[JsAnonymous]
	public class TextAreaConfig : System.DotWeb.JsDynamic {
		/// <summary> The minimum height to allow when grow = true (defaults to 60)</summary>
		...
		/// <summary> True to prevent scrollbars from appearing regardless of how much text is in the field (equivalent to setting overflow: hidden, defaults to false)</summary>
		public bool preventScrollbars { get { return (bool)this["preventScrollbars"]; } set { this["preventScrollbars"] = value; } }

		/// <summary>{String/Object} A DomHelper element spec, or true for a default element spec (defaults to {tag: "textarea", style: "width:100px;height:60px;", autocomplete: "off"})</summary>
