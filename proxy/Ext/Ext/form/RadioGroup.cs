...
namespace Ext.form {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\contrib\proxy\ExtJsParser\ext-2.2\source\widgets\form\RadioGroup.js</jssource>
	public class RadioGroup : Ext.form.CheckboxGroup {
		...
		/// <returns></returns>
		public extern RadioGroup(Ext.Element config);
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public extern RadioGroup(string config);

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public extern static RadioGroup prototype { get; set; }

		/// <summary>The reference to the constructor function</summary>
		public extern static Delegate constructor { get; set; }

		/// <summary>The reference to the class that this class inherits from</summary>
		public extern static Ext.form.CheckboxGroup superclass { get; set; }
	...
	[JsAnonymous]
	public class RadioGroupConfig : System.DotWeb.JsDynamic {
		/// <summary> True to allow every item in the group to be blank (defaults to false). If allowBlank = false and no items are selected at validation time, {@link @blankText} will be used as the error text.</summary>
		public extern bool allowBlank { get; set; }
