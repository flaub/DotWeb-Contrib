...
namespace Ext.form {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\contrib\ExtJsParser\ext-2.2\source\widgets\form\NumberField.js</jssource>
	...
	public class NumberFieldConfig : System.DotWeb.JsDynamic {
		...
		/// <summary> False to disallow decimal values (defaults to true)</summary>
		public bool allowDecimals { get { return (bool)this["allowDecimals"]; } set { this["allowDecimals"] = value; } }

		/// <summary> Character(s) to allow as the decimal separator (defaults to '.')</summary>
		public string decimalSeparator { get { return (string)this["decimalSeparator"]; } set { this["decimalSeparator"] = value; } }

		/// <summary> The maximum precision to display after the decimal separator (defaults to 2)</summary>
		public double decimalPrecision { get { return (double)this["decimalPrecision"]; } set { this["decimalPrecision"] = value; } }

		/// <summary> False to prevent entering a negative sign (defaults to true)</summary>
		public bool allowNegative { get { return (bool)this["allowNegative"]; } set { this["allowNegative"] = value; } }
		...
		public string nanText { get { return (string)this["nanText"]; } set { this["nanText"] = value; } }

		/// <summary> The base set of characters to evaluate as valid numbers (defaults to '0123456789').</summary>
		public string baseChars { get { return (string)this["baseChars"]; } set { this["baseChars"] = value; } }
