...
namespace Ext.form {
	...
	/// </summary>
	/// <jssource>D:\src\git\DotWeb\contrib\proxy\ExtJsParser\ext-2.3\widgets\form\FieldSet.js</jssource>
	public class FieldSet : Ext.Panel {

		/// <summary></summary>
		/// <returns></returns>
		public extern FieldSet();
		/// <summary></summary>
		/// <param name="config">Configuration options</param>
		/// <returns></returns>
		public extern FieldSet(object config);
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public extern FieldSet(Ext.Element config);
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public extern FieldSet(string config);

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public extern static FieldSet prototype { get; set; }
		...
		/// <summary>
		///     True to render a checkbox into the fieldset frame just in front of the legend,or a DomHelper config object to create the checkbox.  (defaults to false).
		///     The fieldset will be expanded or collapsed when the checkbox is toggled.
		/// </summary>
		public extern object checkboxToggle { get; set; }

		/// <summary>The name to assign to the fieldset's checkbox if {@link #checkboxToggle} = true(defaults to '[checkbox id]-checkbox').</summary>
		public extern string checkboxName { get; set; }
		...
		/// <summary>True to animate the transition when the panel is collapsed, false to skip the animation (defaults to false).</summary>
	...
	[JsAnonymous]
	public class FieldSetConfig : System.DotWeb.JsDynamic {
		/// <summary> True to render a checkbox into the fieldset frame just in front of the legend, or a DomHelper config object to create the checkbox.  (defaults to false). The fieldset will be expanded or collapsed when the checkbox is toggled.</summary>
		public extern object checkboxToggle { get; set; }
