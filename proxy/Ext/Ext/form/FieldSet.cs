...
namespace Ext.form {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\contrib\ExtJsParser\ext-2.2\source\widgets\form\FieldSet.js</jssource>
	...
	public class FieldSetConfig : System.DotWeb.JsDynamic {
		...
		public object checkboxToggle { get { return (object)this["checkboxToggle"]; } set { this["checkboxToggle"] = value; } }

		/// <summary> The name to assign to the fieldset's checkbox if {@link #checkboxToggle} = true (defaults to '[checkbox id]-checkbox').</summary>
		public string checkboxName { get { return (string)this["checkboxName"]; } set { this["checkboxName"] = value; } }
