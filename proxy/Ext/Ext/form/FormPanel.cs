...
namespace Ext.form {
	...
	public class FormPanelConfig : System.DotWeb.JsDynamic {
		/// <summary> (optional) The id of the FORM tag (defaults to an auto-generated id).</summary>
		public string formId { get { return (string)this["formId"]; } set { this["formId"] = value; } }
		...
		public double labelWidth { get { return (double)this["labelWidth"]; } set { this["labelWidth"] = value; } }
		...
		public string labelAlign { get { return (string)this["labelAlign"]; } set { this["labelAlign"] = value; } }
		...
		public bool monitorValid { get { return (bool)this["monitorValid"]; } set { this["monitorValid"] = value; } }

		/// <summary> The milliseconds to poll valid state, ignored if monitorValid is not true (defaults to 200)</summary>
		public double monitorPoll { get { return (double)this["monitorPoll"]; } set { this["monitorPoll"] = value; } }
