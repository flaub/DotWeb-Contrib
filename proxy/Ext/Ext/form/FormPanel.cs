...
namespace Ext.form {
	...
	///     });</code></pre>
	/// </summary>
	/// <jssource>D:\src\git\DotWeb\contrib\proxy\ExtJsParser\ext-2.3\widgets\form\Form.js</jssource>
	public class FormPanel : Ext.Panel {

		/// <summary></summary>
		/// <returns></returns>
		public extern FormPanel();
		/// <summary></summary>
		/// <param name="config">Configuration options</param>
		/// <returns></returns>
		public extern FormPanel(object config);
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public extern FormPanel(Ext.Element config);
		/// <summary></summary>
		/// <param name="config">The configuration options.</param>
		/// <returns></returns>
		public extern FormPanel(string config);

		/// <summary></summary>
		/// <summary>The reference to the prototype the every object of this type is constructed with</summary>
		public extern static FormPanel prototype { get; set; }
		...
		public extern string formId { get; set; }
		...
		public extern double labelWidth { get; set; }
		...
		/// </summary>
		public extern string labelAlign { get; set; }

		/// <summary>
		///     If true, the form monitors its valid state <b>client-side</b> andregularly fires the {@link #clientvalidation} event passing that state.<br>
		...
		public extern virtual void getForm();
		...
		/// </summary>
		/// <returns></returns>
		public extern virtual void startMonitoring();

		/// <summary>Stops monitoring of the valid state of this form</summary>
		/// <returns></returns>
		public extern virtual void stopMonitoring();
	...
	[JsAnonymous]
	public class FormPanelConfig : System.DotWeb.JsDynamic {
		/// <summary> (optional) The id of the FORM tag (defaults to an auto-generated id).</summary>
		public extern string formId { get; set; }
		...
		/// <summary>  An array of {@link Ext.Button}s or {@link Ext.Button} configs used to add buttons to the footer of this FormPanel.<br> <p>Buttons in the footer of a FormPanel may be configured with the option <tt>formBind: true</tt>. This causes the form's {@link #monitorValid valid state monitor task} to enable/disable those Buttons depending on the form's valid/invalid state.</p></summary>
		public extern System.Array buttons { get; set; }
		...
		/// <summary> If true, the form monitors its valid state <b>client-side</b> and regularly fires the {@link #clientvalidation} event passing that state.<br> <p>When monitoring valid state, the FormPanel enables/disables any of its configured {@link #button}s which have been configured with <tt>formBind: true</tt> depending on whether the form is valid or not.</p></summary>
		public extern bool monitorValid { get; set; }
