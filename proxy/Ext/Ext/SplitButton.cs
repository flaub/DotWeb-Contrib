...
namespace Ext {
	...
	/// </summary>
	/// <jssource>F:\src\git\DotWeb\contrib\proxy\ExtJsParser\ext-2.2\source\widgets\SplitButton.js</jssource>
	public class SplitButton : Ext.Button {
		...
		/// <returns></returns>
		public extern virtual void setArrowHandler();

		/// <summary>Sets this button's arrow click handler.</summary>
		/// <param name="handler">The function to call when the arrow is clicked</param>
		/// <returns></returns>
		public extern virtual void setArrowHandler(Delegate handler);

		/// <summary>Sets this button's arrow click handler.</summary>
		/// <param name="handler">The function to call when the arrow is clicked</param>
		/// <param name="scope">(optional) Scope for the function passed above</param>
		/// <returns></returns>
		public extern virtual void setArrowHandler(Delegate handler, object scope);
